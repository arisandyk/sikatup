<div class="mb-5 border-none shadow-lg bg-white p-4 rounded-lg">
    <div class="flex-auto">
        <div class="flex flex-col pl-0 mb-0 rounded-lg">
            <h4 class="mb-5 text-xl font-bold">About</h4>
            <ul class="space-y-4">
                ...
                <li class="flex gap-x-4">
                    <i>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-crown">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <h4 class="my-5 text-xl font-bold">Contact</h4>
            <ul class="space-y-4">
                <li class="flex gap-x-4">
                    <i>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
