        ...
        <div class="w-full bg-white rounded-lg flex justify-center shadow-lg border p-4">
            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="172mm" height="120mm" version="1.1"
                ...
                <g id="Layer_x0020_1">
                    ...
                    <g id="_2785720127792">
                        <line class="{{ $isActive[0] ? 'str1' : 'str0' }} fil0" x1="2927.83" y1="663.54" x2="2927.83" y2= "5383.71" />
                        <line class="{{ $isActive[0] ? 'str1' : 'str0' }} fil0" x1="2922.99" y1="829.97" x2="2597.1" y2= "829.97" />
                        <rect class="{{ $isActive[0] ? 'str1' : 'str0' }} fil0" x="2120.71" y="684.51" width="476.39" height="303.45" />
                        <line class="{{ $isActive[0] ? 'str1' : 'str0' }} fil0" x1="2119.53" y1="683.77" x2="2597.76" y2= "977.42" />
                        <line class="{{ $isActive[0] ? 'str1' : 'str0' }} fil0" x1="2598.77" y1="684.58" x2="2120.71" y2= "978.13" />
                        ...
                        <line class="{{ $isActive[0] ? 'str1' : 'str0' }} fil0" x1="2111.77" y1="829.06" x2="1894.27" y2= "829.06" />
                        <polygon class="{{ $isActive[0] ? 'fil2' : 'fil1' }}"
                            points="2914.16,179.89 3022.31,419.39 3130.47,658.9 2913.46,658.9 2696.45,658.9 2805.31,419.39 " />
                        <line class="{{ $isActive[0] ? 'str1' : 'str0' }} fil0" x1="2927.83" y1="1395.23" x2="2636.52" y2= "1395.23" />
                        <polyline class="{{ $isActive[0] ? 'str1' : 'str0' }} fil0" points="2936.96,2037.89 3150.84,2037.89 3275.72,1897.39 " />
                        <circle class="{{ $isActive[0] ? 'str1' : 'str0' }} fil0" cx="2918.07" cy="2789.03" r="220.48" />
                        <rect class="{{ $isActive[0] ? 'fil2' : 'fil1' }}" x="2702.88" y="3155.84" width="464.35" height="422.02" />
                        <polygon class="{{ $isActive[0] ? 'fil2' : 'fil1' }}"
                        ...
                        <polyline class="{{ $isActive[0] ? 'str1' : 'str0' }} fil0" points="2927.83,4030.29 3549.61,4030.29 3549.61,4376.9 " />
                        <polyline class="{{ $isActive[0] ? 'str1' : 'str0' }} fil0" points="3544.34,6573.08 3544.34,4890.32 3771.88,4408.78 " />
                        ...
                        <g>
                            ...
                            <line class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0" x1="6324.35" y1="11341.11" x2="6324.35" y2= "5431.65" />
                            <line class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0" x1="6920.82" y1="6575.27" x2="6920.82" y2= "7030.35" />
                            <polyline class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0"
                                points="6324.35,7972.27 6931.4,7972.27 6931.4,7607.14 7153.65,7125.6 " />
                            <rect class="{{ $isActive[1] ? 'fil2' : 'fil1' }}" x="6116.49" y="8064.86" width="425.98" height="338.67" />
                            <circle class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0" cx="6324.35" cy="8697.23" r="207.54" />
                            <g>
                                <rect class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0" x="5496.27" y="9025.5" width="619.66" height="354.42" />
                                <line class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0" x1="5494.73" y1="9024.64" x2="6116.79"
                                    y2= "9367.61" />
                                <line class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0" x1="6118.1" y1="9025.59" x2="5496.26"
                                    y2= "9368.43" />
                            </g>
                            <polygon class="{{ $isActive[1] ? 'fil2' : 'fil1' }}"
                                points="4765.81,9210.57 4976.83,9115.65 5187.85,9020.73 5187.85,9210.57 5187.85,9400.42 4976.83,9305.49 " />
                            <line class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0" x1="5500.9" y1="9211.56" x2="5189.12" y2= "9211.56" />
                            <circle class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0" cx="6324.35" cy="9922.98" r="191.82" />
                            <circle class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0" cx="6435.47" cy="10105.54" r="191.82" />
                            <circle class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0" cx="6211.9" cy="10105.54" r="191.82" />
                            <line class="{{ $isActive[1] ? 'str1' : 'str0' }} fil0" x1="6324.35" y1="9198.63" x2="6115.93" y2= "9198.63" />
                        </g>
                        <line class="{{ $isActive[2] ? 'str1' : 'str0' }} fil0" x1="10889.84" y1="6572.6" x2="10889.84" y2= "7133.52" />
                        <line class="{{ $isActive[2] ? 'str1' : 'str0' }} fil0" x1="13683.85" y1="6572.6" x2="13683.85" y2= "7133.52" />
                        <rect class="{{ $isActive[2] ? 'fil2' : 'fil1' }}" x="12661.21" y="7810.85" width="329.41" height="428.62" />
                        <line class="{{ $isActive[2] ? 'str1' : 'str0' }} fil0" x1="11170.26" y1="7195.7" x2="10932.14" y2= "7695.76" />
                        ...
                        <circle class="{{ $isActive[2] ? 'fil2' : 'fil1' }}" cx="12033.41" cy="8027.81" r="231.52" />
                        <line class="{{ $isActive[2] ? 'str1' : 'str0' }} fil0" x1="52.75" y1="5436.17" x2="17147.25" y2= "5436.17" />
                        <line class="{{ $isActive[2] ? 'str1' : 'str0' }} fil0" x1="52.75" y1="6622.67" x2="17147.25" y2= "6622.67" />
                    </g>
                </g>
            </svg>
        </div>
