    ...
    @if ($activeTab === 'account')
                    ...
                    <div class="row mb-4">
                        <div class="col-md-3 text-center">
                            <div class="profile-image-container mb-3">
                                ...
                                <input type="file" id="profilePicture" class="upload-input d-none"
                                    wire:model="profilePicture">
                            </div>
                            <button type="button" class="btn btn-outline-primary btn-sm upload"
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="unitInduk" class="form-control" wire:model="unitInduk"
                                        wire:change="$refresh">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="basecamp" class="form-control" wire:model="basecamp"
                                        wire:change="$refresh">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="garduInduk" class="form-control" wire:model="garduInduk"
                                        wire:change="$refresh">
        ...
        <div class="card mt-4">
            <div class="card-body">
                ...
                <p class="text-muted">Are you sure you want to delete your account? Once you delete your account, there
                ...
                <button class="btn btn-danger mt-3 btn-lg" wire:click="deleteAccount"
    ...
    @if ($activeTab === 'security')
        ...
        <div class="card mt-4">
            <div class="card-body">
                ...
                <button class="btn btn-primary btn-lg" wire:click="enableTwoFactor">Enable Two-Factor
