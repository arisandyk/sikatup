<div
    class="w-full lg:w-auto fixed top-0 left-0 lg:left-[280px] lg:right-0 p-4 lg:p-0 lg:pt-5 lg:pr-5 lg:pl-5 flex flex-col md:flex-row gap-2 md:gap-12 justify-normal md:justify-between items-start md:items-center z-40 bg-primary backdrop-blur-md bg-opacity-95 border-none lg:border-b">
    ...
    <div class="flex justify-between md:justify-normal md:gap-x-4 items-center w-full">
        <button class="p-1 bg-secondary rounded-lg block lg:hidden" id="btn-toggle">
    ...
    <div class="w-full lg:w-[670px] flex items-center bg-white rounded-lg py-3 px-4 shadow-lg space-x-2">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
